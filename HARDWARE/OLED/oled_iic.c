...
{ 	 
	...
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//速度50MH
 	...
 	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_5|GPIO_Pin_7;				 //PC6,7 OUT推挽输出
 	GPIO_Init(GPIOA, &GPIO_InitStructure);
 	GPIO_SetBits(GPIOA,GPIO_Pin_5|GPIO_Pin_7);						 //PC6,7 OUT  输出高
